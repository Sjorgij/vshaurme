...
Сейчас очень нужна помощь с моделированием системы, почитать о которой можно [здесь](https://docs.djangoproject.com/en/4.2/intro/tutorial02/#creating-models).
